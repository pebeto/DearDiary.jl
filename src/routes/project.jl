"""
    get_project_by_id_handler(request::HTTP.Request, id::Int)::HTTP.Response
...
"""
    get_projects_handler(request::HTTP.Request)::HTTP.Response
...
"""
    create_project_handler(request::HTTP.Request,
        parameters::Json{ProjectCreatePayload})::HTTP.Response

!!! warning
    This function is for route handling and should not be called directly.
"""
@admin_required function create_project_handler(request::HTTP.Request,
    parameters::Json{ProjectCreatePayload})::HTTP.Response
...
"""
    update_project_handler(request::HTTP.Request, id::Int,
        parameters::Json{ProjectUpdatePayload})::HTTP.Response

!!! warning
    This function is for route handling and should not be called directly.
"""
function update_project_handler(request::HTTP.Request, id::Int,
    parameters::Json{ProjectUpdatePayload})::HTTP.Response
...
"""
    delete_project_handler(request::HTTP.Request, id::Int)::HTTP.Response

!!! warning
    This function is for route handling and should not be called directly.
"""
function delete_project_handler(request::HTTP.Request,
